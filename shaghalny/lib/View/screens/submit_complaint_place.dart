...
import '/View/screens/submit_complaint_job.dart';
...
class SubmitComplaintAboutPlace extends StatelessWidget {
  String employerId;
  String employerName;

  SubmitComplaintAboutPlace({required this.employerId, required this.employerName, Key? key})
      : super(key: key);
              ...
              child:
                ...
                PrimaryButton(
                    ...
                    onTap: () {if (complaintKey.currentState!.validate()){
                      ComplaintReviewCubit.get(context).complaintAboutPlace(
                        prefCubit,
                      ...
                      //     context,
                      //     MaterialPageRoute(
                      //         builder: (context) => SubmitComplaintAboutJob(jobId: '', employerName: '',)));
                    }),
